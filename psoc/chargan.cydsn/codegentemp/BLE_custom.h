...
#define CYBLE_CHARGAN_SERVICE_INDEX   (0x00u) /* Index of Chargan service in the cyBle_customs array */
#define CYBLE_CHARGAN_COMMAND_CHAR_INDEX   (0x00u) /* Index of Command characteristic */
#define CYBLE_CHARGAN_COMMAND_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_INDEX   (0x00u) /* Index of Client Characteristic Configuration descriptor */


#define CYBLE_CHARGAN_SERVICE_HANDLE   (0x000Cu) /* Handle of Chargan service */
#define CYBLE_CHARGAN_COMMAND_CHAR_HANDLE   (0x000Eu) /* Handle of Command characteristic */
#define CYBLE_CHARGAN_COMMAND_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_HANDLE   (0x000Fu) /* Handle of Client Characteristic Configuration descriptor */
