    ...
    const CYBLE_GATTS_T cyBle_gatts =
{
    ...
    /* Device Name */
    (uint8)'C', (uint8)'H', (uint8)'A', (uint8)'R', (uint8)'G', (uint8)'A', (uint8)'N', 
...
CYBLE_GATTS_ATT_GEN_VAL_LEN_T cyBle_attValuesLen[CYBLE_GATT_DB_ATT_VAL_COUNT] = {
    ...
    { 0x0010u, (void *)&cyBle_attUuid128[0] }, /* Chargan UUID */
    { 0x0010u, (void *)&cyBle_attUuid128[1] }, /* Command UUID */
    { 0x001Eu, (void *)&cyBle_attValues[21] }, /* Command */
...
const CYBLE_GATTS_DB_T cyBle_gattDB[0x0Fu] = {
    ...
    { 0x0003u, 0x2A00u /* Device Name                         */, 0x00000A04u /* rd,wr         */, 0x0003u, {{0x0007u, (void *)&cyBle_attValuesLen[0]}} },
    ...
    { 0x000Du, 0x2803u /* Characteristic                      */, 0x00001E01u /* rd,wr,wwr,ntf */, 0x000Fu, {{0x0010u, (void *)&cyBle_attValuesLen[6]}} },
    { 0x000Eu, 0x0000u /* Command                             */, 0x00091E04u /* rd,wr,wwr,ntf */, 0x000Fu, {{0x001Eu, (void *)&cyBle_attValuesLen[7]}} },
